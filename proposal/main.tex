...
\begin{itemize}
    \item \textbf{Member 1:} Rudra Dudhat, B24DS506, rudramd@iitbhilai.ac.in. Literature review, project scaffold, and most of the coding.
    \item \textbf{Member 2:} Vatsal Yadav, B24DS036, vatsal@iitbhilai.ac.in. Verifying the results and running further experiments for the visualizations.
    \item \textbf{Member 3:} Mohak Arya, 12341420, mohak@iitbhilai.ac.in. Ideation, and putting together deliverables such as this proposal.
\end{itemize}
